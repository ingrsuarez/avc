			...
			<nav class="menu__horiz">
				<ul class="dropdown__menu__horiz">
					<li class="dropdown__horiz__item">
						<span id="horiz1"><a><i class="fas fa-user"></i> <?php echo (ucfirst($nombre))?></a><i class="fas fa-angle-right" style="padding-left: 10px;" id="flecha1"></i></span>
					...
					<li class="dropdown__horiz__item">
						...
						<ul class="inside__menu__horiz" id="horiz3__inside" style="opacity: 0">
							<li class="inside__item__horiz">
								<a href="https://www.cinqn.org.ar//" target="_blank"><i class="fas fa-laptop-medical" style="padding-right: 10px;"></i> Colegio de ingenieros</a>
							</li>
<!-- 							<li class="inside__item__horiz">
