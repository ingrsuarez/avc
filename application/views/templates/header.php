...
<body>
	...
	<header class="header">
		<nav class="menu">
			<div class="menu__logo" ><img src="<?php echo base_url(); ?>clientes/AVC/imagenes/logoColor.png"></div>
			<ul class="menu__item" >
				...
				<li class="dropdown__item dropdown__item--active" id="active">
					<a href="<?php echo base_url(); ?>obras/pedidos/" >OBRAS</a>
				</li>
				<li class="dropdown__item" id="procedimientos">
					<a href="<?php echo base_url(); ?>index.php/procedimientos/instructivos/">COMPRAS</a>
				...
				<li class="dropdown__item" id="registros">
					<a href="<?php echo base_url(); ?>index.php/registros/circulares/" >VENTAS</a>
